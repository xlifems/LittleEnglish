...
--
-- Estructura de tabla para la tabla `ins_niveles`
--

CREATE TABLE `ins_niveles` (
  `id_nivel` int(10) NOT NULL,
  `nombre_nivel` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `ins_niveles`
--
...
CREATE TABLE `ins_usuarios` (
  ...
  `usuario_nickname` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `usuario_tidentificacion` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `usuario_identificacion` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `usuario_nombres` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `usuario_apellidos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `usuario_departamento` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `usuario_ciudad` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `usuario_direccion` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `usuario_barrio` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `usuario_telefono` int(12) DEFAULT NULL,
  `usuario_correo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `usuario_password` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `usuario_tipo` varchar(5) COLLATE utf8_spanish_ci DEFAULT NULL
